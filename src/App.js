...
import { faBook, faFileCode, faInfoCircle, faTerminal } from '@fortawesome/fontawesome-free-solid';
      ...
      <Router>
        <div>
          <Navbar color="dark" dark expand="md">
            ...
            <Nav navbar className="m-0 mr-md-4 ml-md-4 ml-auto">
              ...
              <NavItem className="ml-3">
                <NavLink>
                  <FontAwesomeIcon icon={faBook} size="1x" title="Documentation" className="align-middle d-none d-lg-inline-block" />
