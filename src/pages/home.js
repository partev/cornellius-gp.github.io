...
import { faBook, faFileCode } from '@fortawesome/fontawesome-free-solid';
...
class Home extends React.Component {
  render() {
    ...
    return (
      <div>
        <div className="jumbotron jumbotron-fluid shadow-bottom" style={backgroundStyle}>
          <div className="container text-center">
            <div className="row">
              <div className="col-12">
                <h1 className="display-3 font-weight-bold" style={{paddingBottom: "90px"}}>GPyTorch</h1>
                <div className="m-4">
            ...
            <div className="row">
              <div className="col-12 text-center">
                ...
                <div className="alert alert-warning pt-3 pb-3" role="alert">
                  <strong>GPyTorch requires Python >= 3.8</strong>
                </div>
                <p className="pt-3">
                  Make sure you have <a href="https://pytorch.org/get-started/locally/">PyTorch installed</a>. Then,
                </p>
            ...
            <div className="col-12 col-md-8 offset-md-2 text-center">
              <figure>
                <figcaption className="figure-caption">
                  Developed at Cornell University, Columbia University, University of Pennsylvania, New York University, and Meta,
                  with funding from
                  the <a href="https://www.gatesfoundation.org/" target="_blank" rel="noopener noreferrer">Bill and Melinda Gates Foundation</a>,
                  the <a href="https://www.nsf.gov/" target="_blank" rel="noopener noreferrer">National Science Foundation</a>,
                  <a href="https://www.sap.com/index.html" target="_blank" rel="noopener noreferrer">SAP</a>,
                  the <a href="https://www.simonsfoundation.org/" target="_blank" rel="noopener noreferrer">Simons Foundation</a>, and
                  the <a href="https://www.gatsby.org.uk/" target="_blank" rel="noopener noreferrer">Gatsby Charatable Trust</a>.
                </figcaption>
              </figure>
            </div>
          </div>
